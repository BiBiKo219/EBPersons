...
model = dict(
    ...
    detector=dict(
        backbone=dict(
            ...
            depths=[2, 2, 6, 2],
            num_heads=[3, 6, 12, 24],
            strides=(4, 2, 2, 1),    # strides=(4, 2, 2, 2)
            dilations=(1, 1, 1, 2),  # dilations=(1, 1, 1, 1)
            window_size=7,
            mlp_ratio=4,
            qkv_bias=True,
            qk_scale=None,
...
resume_from = 'work_dirs/selsa_faster_rcnn_swin_dc5_1x_imagenetvid_our/epoch_11.pth'